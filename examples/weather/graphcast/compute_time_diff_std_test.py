...
from utility import ERA5PARQUETDatapipe
...
def main(cfg: DictConfig) -> None:
    ...
    DataPipe = ERA5PARQUETDatapipe  # [T,num_channel, 721, 1440], grid features
    datapipe = DataPipe(
        data_dir=to_absolute_path(os.path.join(cfg.dataset_path)),
        stats_dir=to_absolute_path(os.path.join(cfg.dataset_path)),
